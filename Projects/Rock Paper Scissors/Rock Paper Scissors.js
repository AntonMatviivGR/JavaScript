...
document.querySelector('.reset-score-button').addEventListener('click', () => resetWarning());
...
document.body.addEventListener('keydown', (event) => {
  ...
  else if (event.key === 'Backspace') resetWarning();
});
...
function resetWarning() {
  ...
  document.querySelector('.no-button').addEventListener('click', () => document.querySelector('.warning').innerHTML = ``);
}
